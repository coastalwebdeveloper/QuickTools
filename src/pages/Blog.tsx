...
const blogPosts = [
  ...
  { id: "content-creation-tools", title: "Essential Tools for Content Creators in 2025", excerpt: "Discover browser-based tools that professional content creators use to streamline workflows and produce high-quality content faster.", category: "Content Creation", icon: Image, readTime: "12 min read", path: "/blog/content-creation-tools" },
  { id: "productivity-tools-students", title: "Essential Productivity Tools for Students", excerpt: "Free, browser-based tools that help students manage assignments, optimize study materials, and boost academic productivity.", category: "Productivity", icon: BookOpen, readTime: "10 min read", path: "/blog/productivity-tools-students" },
  { id: "web-development-tools", title: "Essential Browser-Based Tools for Web Developers", excerpt: "Free, instant-access tools that professional web developers use daily to streamline workflows and optimize websites.", category: "Web Development", icon: FileText, readTime: "11 min read", path: "/blog/web-development-tools" },
